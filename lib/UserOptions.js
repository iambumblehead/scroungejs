...
var UserOptions = module.exports = (function () {
  ...
  return {
    getNew : function (spec) {
      ...
      that.isUpdateOnly = spec.isUpdateOnly === 'true';
      that.isCopyright = spec.isCopyright === 'true';
      that.isRecursive = spec.isRecursive === 'true' || spec.r || false;
      that.isConcatenation = spec.isConcatenation === 'true';
      that.isMintFilter = spec.isMintFilter === 'true' || spec.m || false;
      that.isCompressed = spec.isCompressed === 'true';
      that.isTimestamped = spec.isTimestamped === 'true';
      that.isRemoveConsole = spec.isRemoveConsole === 'true';
      that.isWarning = spec.isWarning === 'true' || spec.w || false;
      that.isLines = spec.isLines === 'true' || spec.l;
      that.isClosure = spec.isClosure === 'true' || spec.c || false;
      that.isSilent = spec.isSilent === 'true' || spec.s || false;
