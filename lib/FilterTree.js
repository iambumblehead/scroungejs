...
var FilterTree = module.exports = (function () {
  ...
  var filter = {
    ...
    getFilteredTreeArr : function (origTreeArr) {
      ...
      // remove trees that would be filtered
  ...
  return {
    ...
    isTreePassingFilters : function (tree, filters, opts) {
      var isTreePassing = false;
      ...
      return isTreePassing;
    },

    isTreeInfoNodeInTreeArr : function (treeInfo, treeInfoArr) {
      var x, count = 0;

      for (x = treeInfoArr.length; x--;) {
        //console.log(treeInfoArr[x].fileObjArr);
        //if (treeInfoArr[x].fileObjArr)
      }
